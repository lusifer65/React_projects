...
const Videos = () => {
  ...
  return (
    <Stack direction={["column", "row"]} h={["150vh","110vh"]} my={"20"} boxSizing={"border-box"}>
      <VStack w={"full"} p={"2"} boxSizing={"border-box"}>
        <video
          src={videosArr[videoIndex]}
          controls
          controlsList="nodownload"
          style={{ width: "100%" }}
        />
        <VStack w={"full"} p={"8"} alignItems={["center","flex-start"]} overflowY={"auto"}>
          <Heading>Video:- {videoIndex + 1}</Heading>
          <Text>this is the discription</Text>
        </VStack>
      </VStack>
      <VStack
        w={["full", "xl"]}
